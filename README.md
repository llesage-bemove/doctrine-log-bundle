...
This is a fork from [manasbala/doctrine-log-bundle](https://github.com/manasbala/doctrine-log-bundle)
The purpose of this repo is only to try on PHP8.0/Symfony5.4 
